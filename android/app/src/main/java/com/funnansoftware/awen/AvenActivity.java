...
/**
 * Main Android activity for awen.
 *
 ...
 * code is linked directly into libawen.so — there is no separate libSDL3.so.
 * Only "awen" needs to be loaded; SDL3's JNI entry points are exported from
 * libawen.so automatically.
 *
